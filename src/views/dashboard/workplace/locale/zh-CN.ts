export default {
  ...
  'workplace.Brush.questions': '今日刷题量',
  'workplace.Number.of.login': '今日登录次数',
  'workplace.Number.of.classes': '今日排课次数',
  'workplace.Class.students': '今日带上课学员',
  'workplace.minute': '分钟',
  'workplace.docs': '帮助文档',
  ...
  'workplace.Top.20.most.popular.questions': '最受欢迎20道题',
  'workplace.Latest.class.arrangement.information': '最近排课信息',
